...
export default function Header({ isHeroSection = true, isBackButton = false }) {
      ...
      <header className="flex flex-col items-end px-7 pt-4 pb-8 w-full bg-white rounded-[16px] shadow-[0px_0px_4px_rgba(0,0,0,0.2)]">
        ...
        {isBackButton && (
          <div className="mt-[-1rem] flex justify-start w-full">
            <button
              className="bg-transparent p-0 border-0 cursor-pointer inline-flex items-center justify-center"
              onClick={() => navigate(-1)}
            >
